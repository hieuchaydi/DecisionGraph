...
export const DOC_SECTIONS: DocSection[] = [
  ...
  },
  {
    ...
    bullets: {
      vi: [
        ...
        'Hỗ trợ `x-api-key` để test môi trường API protected.',
      ...
      en: [
        ...
        'Supports `x-api-key` for protected API environments.',
  ...
  },
  {
    ...
    code: [
      ...
      '  docs-DecisionGraph/         # React + TS + Vite docs frontend',
  ...
  {
    id: 'prompt-playbook',
    title: { vi: 'Prompt Playbook (VI/EN)', en: 'Prompt Playbook (VI/EN)' },
    summary: {
